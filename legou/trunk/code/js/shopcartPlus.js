...
$(function(){
   ...
   //表头的全选
	$theadInput.change(function(){
		...
		$totalPriceInput.prop('checked',checkState);//吧状态给计算总价的全选框
	...
	*/
	...
	/*
	   表格中的选择框 反过来影响上下两个全选框
	      1.给表格中的选择框绑定点击事件
		  2.定一个标杆 flag = true；
		  3.循环表格中的选择框
		  4.获取每一个选择框的选中状态
		      判断：如果有一个是false 那么就不是全选. flag = false；
		  5.把flag的值赋值给两个全选框（因为flag就是对应的选中状态）
	*/
    $tbodyInput.change(function(){ //给表格中单选框绑定事件
    ...
    */
	...
	function getGoodsCount() {
		//获取数量
		var goodsCount = $('tatle tbody tr').length;
		//渲染
